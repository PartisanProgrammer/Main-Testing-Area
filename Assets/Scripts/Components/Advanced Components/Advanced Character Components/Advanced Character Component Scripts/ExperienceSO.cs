...
using UnityEngine;
[CreateAssetMenu(fileName = "New Experience Data", menuName = "Character/Advanced Character/Experience/Level/Experience")]
public class ExperienceSO : AdvancedCharacterComponentSO
{
